 ...
 */
public class OptimalBufferSizeAnalysisTopDownCli implements IApplication{
	
	private Configuration configuration;

	private IProgressMonitor monitor = new NullProgressMonitor();

	private OptimalBufferSizeAnalysisTopDown analysis;

	
	public static void main(String[] args) {
		ModelsRegister.init();

		OptimalBufferSizeAnalysisTopDownCli cliApp = null;

		try {
			cliApp = new OptimalBufferSizeAnalysisTopDownCli();
			cliApp.parse(args);
	...
	private void run() throws TurnusException {
		...
		{ // STEP 2 : Run the analysis
			...
			try {
				analysis = new OptimalBufferSizeAnalysisTopDown(project);
