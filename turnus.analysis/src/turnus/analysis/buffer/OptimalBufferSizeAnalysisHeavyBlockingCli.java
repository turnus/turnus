 ...
 */
public class OptimalBufferSizeAnalysisHeavyBlockingCli implements IApplication{
	
	private Configuration configuration;

	private IProgressMonitor monitor = new NullProgressMonitor();

	private OptimalBufferSizeAnalysisHeavyBlocking analysis;

	
	public static void main(String[] args) {
		ModelsRegister.init();

		OptimalBufferSizeAnalysisHeavyBlockingCli cliApp = null;

		try {
			cliApp = new OptimalBufferSizeAnalysisHeavyBlockingCli();
			cliApp.parse(args);
	...
	private void run() throws TurnusException {
		...
		{ // STEP 2 : Run the analysis
			...
			try {
				analysis = new OptimalBufferSizeAnalysisHeavyBlocking(project);
