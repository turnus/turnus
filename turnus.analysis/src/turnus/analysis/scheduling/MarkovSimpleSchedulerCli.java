 ...
 *
 */
public class MarkovSimpleSchedulerCli implements IApplication{
	
	private Configuration configuration;

	private IProgressMonitor monitor = new NullProgressMonitor();

	private MarkovSimpleScheduler analysis;

	public static void main(String[] args) {
		ModelsRegister.init();

		MarkovSimpleSchedulerCli cliApp = null;

		try {
			cliApp = new MarkovSimpleSchedulerCli();
			cliApp.parse(args);
	...
	private void run() throws TurnusException {
		...
		{ // STEP 2 : Run the analysis
			...
			try {
				analysis = new MarkovSimpleScheduler(project);
