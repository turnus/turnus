...
public class ListSchedulerPartitioningCli implements IApplication {
	...
	public static void main(String[] args) {
		...
		ListSchedulerPartitioningCli cliApp = null;

		try {
			cliApp = new ListSchedulerPartitioningCli();
			cliApp.parse(args);
	...
	private void run() throws TurnusException {
		monitor.beginTask("List scheduler partitioning analysis", IProgressMonitor.UNKNOWN);
		...
		{
			monitor.subTask("Runs the analysis");
			try {
