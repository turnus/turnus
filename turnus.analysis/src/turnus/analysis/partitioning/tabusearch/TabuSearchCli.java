 ...
 * 
 */
public class TabuSearchCli implements IApplication {
	...
	public static void main(String[] args) {
		...
		TabuSearchCli cliApp = null;

		try {
			cliApp = new TabuSearchCli();
			cliApp.parse(args);
	...
	private void run() throws TurnusException {
		...
		{ // STEP 2 : Run the analysis
			...
			try {
				tabuSearch = new TabuSearch(project, weighter, communication, schedWeight, bufferSize, configuration.getValue(RELEASE_BUFFERS_AFTER_PROCESSING));
