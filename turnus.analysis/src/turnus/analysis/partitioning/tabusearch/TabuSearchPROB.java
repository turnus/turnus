 ...
 * 
 */
public class TabuSearchPROB extends TabuSearchAbstract {
	...
	public TabuSearchPROB(TraceProject tProject, TraceWeighter tWeighter, CommunicationWeight commWeight, SchedulingWeight schedulingWeight, BufferSize bufferSize, boolean release) {
		super(tProject);
		...
		RandomMovesGenerator randomGenerator = new RandomMovesGenerator(project);
		...
		counterTotal.put(randomGenerator, 4);
		
		IdleMovesGenerator idleGenerator = new IdleMovesGenerator(project);
		...
		counterTotal.put(idleGenerator, 4);
		
		CommFreqMovesGenerator cfGenerator = new CommFreqMovesGenerator(project);
		...
		counterTotal.put(cfGenerator, 4);
		
		BalancingMovesGenerator bGenerator = new BalancingMovesGenerator(project);
