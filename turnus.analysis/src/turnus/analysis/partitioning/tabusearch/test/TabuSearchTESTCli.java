 ...
 * 
 */
public class TabuSearchTESTCli implements IApplication {
	...
	public static void main(String[] args) {
		...
		TabuSearchTESTCli cliApp = null;

		try {
			cliApp = new TabuSearchTESTCli();
			cliApp.parse(args);
	...
	private void run() throws TurnusException {
		...
		{ // STEP 2 : Run the analysis
			...
			try {
				tabuSearch = new TabuSearchTEST(project, weighter, bufferSize);
