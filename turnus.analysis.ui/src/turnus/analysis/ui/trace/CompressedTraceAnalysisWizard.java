...
import turnus.analysis.trace.compressor.CompressedTraceAnalysisCli;
 ...
 *
 */
public class CompressedTraceAnalysisWizard extends Wizard implements IWorkbenchWizard {
	...
	public CompressedTraceAnalysisWizard() {
		super();
	...
	public boolean performFinish() {
		...
		final Job job = new Job("Compressed trace analysis") {

			@Override
			protected IStatus run(IProgressMonitor monitor) {
				try {
					new CompressedTraceAnalysisCli().start(configuration, monitor);
