...
import turnus.analysis.trace.markov.ActionsMarkowModelAnalysisCli;
 ...
 *
 */
public class ActionsMarkowModelAnalysisWizard extends Wizard implements IWorkbenchWizard {
	/**
	...
	private class OptionsPage extends AbstractWizardPage {
		...
		private OptionsPage() {
			super("Compressed trace analysis");
			setTitle("Compressed trace analysis");
	...
	public ActionsMarkowModelAnalysisWizard() {
		super();
	...
	public boolean performFinish() {
		...
		final Job job = new Job("Markov model trace analysis") {

			@Override
			protected IStatus run(IProgressMonitor monitor) {
				try {
					new ActionsMarkowModelAnalysisCli().start(configuration, monitor);
