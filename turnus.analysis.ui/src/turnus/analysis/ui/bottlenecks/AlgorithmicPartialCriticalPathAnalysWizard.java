...
import turnus.analysis.bottlenecks.AlgorithmicPartialCriticalPathAnalysisCli;
 ...
 *
 */
public class AlgorithmicPartialCriticalPathAnalysWizard extends Wizard implements IWorkbenchWizard {
	...
	private class OptionsPage extends AbstractWizardPage {
		...
		private OptionsPage() {
			...
			setTitle("Algorithmic bottleneck analysis");
	...
	public AlgorithmicPartialCriticalPathAnalysWizard() {
		super();
