...
import turnus.analysis.pipelining.InternalVariablePipeliningAnalysisCli;
...
public class InternalVariablePipeliningAnalysisWizard extends Wizard implements IWorkbenchWizard {
	...
	private class OptionsPage extends AbstractWizardPage {
		...
		private OptionsPage() {
			...
			setTitle("Pipeling analysis with variable utilisation");
	...
	public InternalVariablePipeliningAnalysisWizard() {
		super();
