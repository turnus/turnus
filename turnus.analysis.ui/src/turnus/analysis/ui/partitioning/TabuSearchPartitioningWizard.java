...
import turnus.analysis.partitioning.tabusearch.TabuSearchCli;
...
public class TabuSearchPartitioningWizard extends Wizard implements IWorkbenchWizard {
	...
	private class OptionsPage extends AbstractWizardPage {
		...
		private OptionsPage() {
			super("Tabu Search Partitioning algorithm");
			setTitle("TabuSearch Partitioning algorithm");
	...
	public TabuSearchPartitioningWizard() {
		super();
	...
	public boolean performFinish() {
		...
		final Job job = new Job("Tabu Search Partitioning algorithm") {
			...
			protected IStatus run(IProgressMonitor monitor) {
				try {
					new TabuSearchCli().start(configuration, monitor);
