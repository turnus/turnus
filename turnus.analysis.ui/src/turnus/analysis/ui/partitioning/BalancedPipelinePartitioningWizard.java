...
import turnus.analysis.partitioning.BalancedPipelinePartitioningCli;
...
public class BalancedPipelinePartitioningWizard extends Wizard implements IWorkbenchWizard {
	...
	private class OptionsPage extends AbstractWizardPage {
		...
		private OptionsPage() {
			...
			setTitle("Balanced Pipeline Partitioning algorithm");
	...
	public BalancedPipelinePartitioningWizard() {
		super();
	...
	public boolean performFinish() {
		...
		final Job job = new Job("Balanced Pipeline Partitioning algorithm") {
			...
			protected IStatus run(IProgressMonitor monitor) {
				try {
					new BalancedPipelinePartitioningCli().start(configuration, monitor);
