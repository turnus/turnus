 ...
 *
 */
public class WidgetSelectPathOptional extends Widget<File> {
	...
	public WidgetSelectPathOptional(Option<File> option, boolean forceEmpty, File initialValue, Composite parent) {
		this(option.name(), option.description(), forceEmpty, initialValue, parent);
	}

	public WidgetSelectPathOptional(Option<File> option, File initialValue, Composite parent) {
		this(option.name(), option.description(), initialValue, parent);
	}

	public WidgetSelectPathOptional(String text, String toolTip, boolean forceEmpty, File initialValue, Composite parent) {
		super(text, toolTip, initialValue, 5, parent);
		this.forceEmpty = forceEmpty;
		setValue(initialValue, true);
	}

	public WidgetSelectPathOptional(String text, String toolTip, File initialValue, Composite parent) {
