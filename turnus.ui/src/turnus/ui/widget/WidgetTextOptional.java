 ...
 *
 */
public class WidgetTextOptional extends Widget<String> {

	private Label lbl;
	private Text textw;
	private String[] unvalidText;

	public WidgetTextOptional(Option<String> option, String initialValue, Composite parent) {
		this(option.name(), option.description(), initialValue, parent);
	}

	public WidgetTextOptional(Option<String> option, String initialValue, String[] unvalidText, Composite parent) {
		this(option.name(), option.description(), initialValue, unvalidText, parent);
	}

	public WidgetTextOptional(String text, String toolTip, String initialValue, Composite parent) {
		this(text, toolTip, initialValue, new String[0], parent);
	}

	public WidgetTextOptional(String text, String toolTip, String initialValue, String[] unvalidText, Composite parent) {
