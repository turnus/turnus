 ...
 *
 */
public class WidgetSelectFile extends Widget<File> {
	...
	public WidgetSelectFile(Option<File> option, String fileExtension, File initialValue, Composite parent) {
		this(option.name(), option.description(), fileExtension, initialValue, parent);
	}

	public WidgetSelectFile(Option<File> option, String[] fileExtensions, File initialValue, Composite parent) {
		this(option.name(), option.description(), fileExtensions, initialValue, parent);
	}

	public WidgetSelectFile(String text, String toolTip, String fileExtension, File initialValue, Composite parent) {
		this(text, toolTip, new String[] { fileExtension }, initialValue, parent);
	}

	public WidgetSelectFile(String text, String toolTip, String[] fileExtensions, File initialValue, Composite parent) {
