 ...
 *
 */
public class FullParallelPartition extends AtomicActorPartition {

	private List<Actor> actorsToExecute = new ArrayList<>();

	public FullParallelPartition(List<Actor> actors, String partitionId) {
		super(actors, partitionId, Integer.MAX_VALUE); 
	}

	@Override
	public List<Actor> getSchedulables() {
		actorsToExecute.clear();
		for (Actor schedulableActor : schedulableActors) {
			actorsToExecute.add(schedulableActor);
		}
