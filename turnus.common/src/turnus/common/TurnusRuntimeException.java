...
/**
 * A generic runtime exception raised by Turnus.
 * 
...
public class TurnusRuntimeException extends RuntimeException {
	 ...
	 *            the message
	 */
	public TurnusRuntimeException(String message) {
		super(message);
		this.throwable = null;
		
		if (message != null)
			Logger.debug("[TurnusRuntimeException] %s", message);
	}

	/**
	 * Create a new runtime exception with the given message and cause
	 * 
	 * @param message
	 *            the message
	 * @param throwable
	 *            the cause
	 */
	public TurnusRuntimeException(String message, Throwable throwable) {
