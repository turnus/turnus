 ...
 * 
 */
public class TabuSearch extends TabuSearchAbstract {
	...
	public TabuSearch(TraceProject tProject, TraceWeighter tWeighter, CommunicationWeight commWeight, SchedulingWeight schedWeight, BufferSize bufferSize, boolean release) {
		super(tProject);
	...
	public void setGenerator(String generator) {
		if (generator == null) {
			...
			Logger.warning("No neighborhood generator specified, idle generator will be used.");
		} else {
