...
/**
 * Compressed trace analysis HTML exporter
 */
public class Ctrace2HtmlExporter extends Ctrace2MdExporter {
	@Override
	public void export(CompressedTraceReport data, File output) throws TurnusException {
		try {
