 ...
 * 
 */
package turnus.model.analysis.util;
 ...
 * <!-- end-user-doc -->
 * @see turnus.model.analysis.AnalysisPackage
 * @generated
 */
public class AnalysisSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AnalysisPackage.ANALYSIS_REPORT: {
				AnalysisReport analysisReport = (AnalysisReport)theEObject;
				T result = caseAnalysisReport(analysisReport);
