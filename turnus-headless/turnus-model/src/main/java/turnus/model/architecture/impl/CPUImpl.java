 ...
 * </p>
 * <ul>
 *   <li>{@link turnus.model.architecture.impl.CPUImpl#getCores <em>Cores</em>}</li>
 *   <li>{@link turnus.model.architecture.impl.CPUImpl#getSchedulers <em>Schedulers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CPUImpl extends ProcessingUnitImpl implements CPU {
	/**
	...
	protected EClass eStaticClass() {
		return ArchitecturePackage.Literals.CPU;
	}
	...
	public void setCores(int newCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.CPU__CORES, oldCores, cores));
	}
	...
	public List<EScheduler> getSchedulers() {
		if (schedulers == null) {
			schedulers = new EDataTypeUniqueEList<EScheduler>(EScheduler.class, this, ArchitecturePackage.CPU__SCHEDULERS);
		}
		return schedulers;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArchitecturePackage.CPU__CORES:
				return getCores();
			case ArchitecturePackage.CPU__SCHEDULERS:
