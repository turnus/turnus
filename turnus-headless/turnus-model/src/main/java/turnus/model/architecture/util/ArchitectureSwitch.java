...
import turnus.model.architecture.*;
...
public class ArchitectureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ArchitecturePackage.ARCHITECTURE: {
				...
				if (result == null) result = caseAttributable(architecture);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitecturePackage.PROCESSING_UNIT: {
				ProcessingUnit processingUnit = (ProcessingUnit)theEObject;
				T result = caseProcessingUnit(processingUnit);
				if (result == null) result = caseAttributable(processingUnit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitecturePackage.MEDIUM: {
				Medium medium = (Medium)theEObject;
				T result = caseMedium(medium);
				if (result == null) result = caseAttributable(medium);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ArchitecturePackage.CPU: {
				CPU cpu = (CPU)theEObject;
				T result = caseCPU(cpu);
				if (result == null) result = caseProcessingUnit(cpu);
				if (result == null) result = caseAttributable(cpu);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitecturePackage.FPGA: {
				FPGA fpga = (FPGA)theEObject;
				T result = caseFPGA(fpga);
				if (result == null) result = caseProcessingUnit(fpga);
				if (result == null) result = caseAttributable(fpga);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitecturePackage.DSP: {
				DSP dsp = (DSP)theEObject;
				T result = caseDSP(dsp);
				if (result == null) result = caseProcessingUnit(dsp);
				if (result == null) result = caseAttributable(dsp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>FPGA</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DSP</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
