...
public class MapFactoryImpl extends EFactoryImpl implements MapFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MapPackage.PORTS_TO_LONG_MAP: return (EObject)createPortsToLongMap();
			default:
	 ...
	 * @generated
	 */
	public Map.Entry<Port, Long> createPortsToLongMap() {
		PortsToLongMapImpl portsToLongMap = new PortsToLongMapImpl();
		return portsToLongMap;
	}
