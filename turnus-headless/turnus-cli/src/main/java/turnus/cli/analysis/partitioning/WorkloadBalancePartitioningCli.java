...
/**
 * CLI command for Workload Balance Partitioning.
 */
@Command(
    name = "workload-balance",
    description = "Run workload balance partitioning",
    mixinStandardHelpOptions = true
)
public class WorkloadBalancePartitioningCli implements PartitioningAlgorithmCli {
    ...
    @Override
    public Integer call() {
        Logger.info("Starting Workload Balance Partitioning...");
        ...
        try {
            ...
            // Run analysis
            WorkloadBalancePartitioning analysis = new WorkloadBalancePartitioning(project, weighter);
            analysis.setConfiguration(config);
            WorkloadBalancePartitioningReport report = analysis.run();
