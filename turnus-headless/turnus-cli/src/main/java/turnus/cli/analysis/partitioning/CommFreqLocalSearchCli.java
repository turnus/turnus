...
/**
 * CLI command for Communication Frequency Local Search Partitioning.
 */
@Command(
    name = "comm-freq-ls",
    description = "Run communication frequency local search partitioning",
    mixinStandardHelpOptions = true
)
public class CommFreqLocalSearchCli implements PartitioningAlgorithmCli {
    ...
    @Override
    public Integer call() {
        Logger.info("Starting Communication Frequency Local Search Partitioning...");
        ...
        try {
            ...
            // Run Comm Freq Local Search
            CommFreqLocalSearch algorithm = new CommFreqLocalSearch(project, weighter, null, null, null, false);
            ...
            // Save report
            File reportFile = new File(outDir, FileUtils.changeExtension(traceFile, "comm_freq_ls_partitioning").getName());
