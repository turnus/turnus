 ...
 *
 */
public class WeighterUtils {

	public static TraceWeighter getTraceWeighter(Configuration configuration, NetworkWeight weights) {
		if (configuration.hasValue(TRACE_WEIGHTER)) {
			String weighter  = configuration.getValue(TRACE_WEIGHTER);
			if (weighter.equals("normal")) {
				return new NormalDistributionTraceWeighter(weights);
			} 
			else {
