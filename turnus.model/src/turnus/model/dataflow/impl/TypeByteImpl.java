...
import turnus.model.dataflow.TypeByte;
 ...
 * </p>
 * <ul>
 *   <li>{@link turnus.model.dataflow.impl.TypeByteImpl#getEtype <em>Etype</em>}</li>
 *   <li>{@link turnus.model.dataflow.impl.TypeByteImpl#getBits <em>Bits</em>}</li>
 *   <li>{@link turnus.model.dataflow.impl.TypeByteImpl#getSize <em>Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeByteImpl extends MinimalEObjectImpl.Container implements TypeByte {
	/**
	...
	protected EClass eStaticClass() {
		return DataflowPackage.Literals.TYPE_BYTE;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataflowPackage.TYPE_BYTE__ETYPE:
				return getEtype();
			case DataflowPackage.TYPE_BYTE__BITS:
				return getBits();
