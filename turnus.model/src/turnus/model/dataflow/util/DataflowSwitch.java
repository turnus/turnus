...
public class DataflowSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DataflowPackage.NETWORK: {
				Network network = (Network)theEObject;
				T result = caseNetwork(network);
				if (result == null) result = caseAttributable(network);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.ACTOR_CLASS: {
				ActorClass actorClass = (ActorClass)theEObject;
				T result = caseActorClass(actorClass);
				if (result == null) result = caseAttributable(actorClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.ACTOR: {
				Actor actor = (Actor)theEObject;
				T result = caseActor(actor);
				if (result == null) result = caseAttributable(actor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = caseAttributable(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.PROCEDURE: {
				Procedure procedure = (Procedure)theEObject;
				T result = caseProcedure(procedure);
				if (result == null) result = caseAttributable(procedure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.VARIABLE: {
			...
			case DataflowPackage.SHARED_VARIABLE: {
				...
				if (result == null) result = caseAttributable(sharedVariable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.PORT: {
				...
				if (result == null) result = caseAttributable(port);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.BUFFER: {
				Buffer buffer = (Buffer)theEObject;
				T result = caseBuffer(buffer);
				if (result == null) result = caseAttributable(buffer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.GUARD: {
				Guard guard = (Guard)theEObject;
				T result = caseGuard(guard);
				if (result == null) result = caseAttributable(guard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.TYPE: {
				Type type = (Type)theEObject;
				T result = caseType(type);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.TYPE_UINT: {
			...
			case DataflowPackage.TYPE_STRING: {
			...
			case DataflowPackage.TYPE_LIST: {
			...
			case DataflowPackage.TYPE_BOOLEAN: {
			...
			case DataflowPackage.TYPE_DOUBLE: {
				TypeDouble typeDouble = (TypeDouble)theEObject;
				T result = caseTypeDouble(typeDouble);
				if (result == null) result = caseType(typeDouble);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.TYPE_UNDEFINED: {
				TypeUndefined typeUndefined = (TypeUndefined)theEObject;
				T result = caseTypeUndefined(typeUndefined);
				if (result == null) result = caseType(typeUndefined);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowPackage.TYPE_TENSOR: {
				TypeTensor typeTensor = (TypeTensor)theEObject;
				T result = caseTypeTensor(typeTensor);
				if (result == null) result = caseType(typeTensor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Type Undefined</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Type Undefined</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTypeUndefined(TypeUndefined object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Type Tensor</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Type Tensor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
