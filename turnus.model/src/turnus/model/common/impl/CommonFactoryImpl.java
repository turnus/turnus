...
public class CommonFactoryImpl extends EFactoryImpl implements CommonFactory {
	...
	public EObject create(EClass eClass) {
		...
		case CommonPackage.ATTRIBUTABLE:
			return (EObject) createAttributable();
		case CommonPackage.STRING_TO_OBJECT_MAP:
			return (EObject) createStringToObjectMap();
		case CommonPackage.STATISTICAL_DATA:
			return createStatisticalData();
		default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case CommonPackage.EOPERATOR:
			return createEOperatorFromString(eDataType, initialValue);
		case CommonPackage.ESCHEDULER:
			return createESchedulerFromString(eDataType, initialValue);
		case CommonPackage.ETYPE:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		...
		case CommonPackage.ESCHEDULER:
			return convertESchedulerToString(eDataType, instanceValue);
		case CommonPackage.ETYPE:
	...
	public StatisticalData createStatisticalData() {
		StatisticalDataImpl statisticalData = new StatisticalDataImpl();
	 ...
	 * @generated
	 */
	public EScheduler createESchedulerFromString(EDataType eDataType, String initialValue) {
		EScheduler result = EScheduler.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException(
					"The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	 ...
	 * @generated
	 */
	public String convertESchedulerToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
