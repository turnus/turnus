...
public class VersioningPackageImpl extends EPackageImpl implements VersioningPackage {
	 ...
	 * @see turnus.model.versioning.VersioningPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getVersion_LastModification() {
	...
	public void createPackageContents() {
		...
		createEAttribute(versionEClass, VERSION__LAST_MODIFICATION);
	...
	public void initializePackageContents() {
		...
		versionEClass.getESuperTypes().add(theCommonPackage.getAttributable());

		// Initialize classes, features, and operations; add parameters
		initEClass(versionEClass, Version.class, "Version", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVersion_VersionDate(), ecorePackage.getEDate(), "versionDate", null, 0, 1, Version.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVersion_LastModification(), ecorePackage.getEDate(), "lastModification", null, 0, 1, Version.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVersion_Id(), ecorePackage.getEString(), "id", null, 0, 1, Version.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
