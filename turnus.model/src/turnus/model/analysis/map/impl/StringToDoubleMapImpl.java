 ...
 * </p>
 * <ul>
 *   <li>{@link turnus.model.analysis.map.impl.StringToDoubleMapImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link turnus.model.analysis.map.impl.StringToDoubleMapImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringToDoubleMapImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,Double> {
	...
	protected EClass eStaticClass() {
		return MapPackage.Literals.STRING_TO_DOUBLE_MAP;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapPackage.STRING_TO_DOUBLE_MAP__KEY, oldKey, key));
	}
	...
	public void setTypedValue(Double newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapPackage.STRING_TO_DOUBLE_MAP__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MapPackage.STRING_TO_DOUBLE_MAP__KEY:
				return getTypedKey();
			case MapPackage.STRING_TO_DOUBLE_MAP__VALUE:
