 ...
 *
 */
public class BottlenecksWithScheduling2MdExporter
		implements FileExporter<BottlenecksWithSchedulingReport, StringBuffer> {
	...
	@Override
	public StringBuffer content(BottlenecksWithSchedulingReport data) {
